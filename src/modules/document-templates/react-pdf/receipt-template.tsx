...
export function ReceiptDocument({ data, settings }: { data: InvoiceTemplateData; settings: TemplateSettings }) {
      ...
      <Page size="A4" style={[styles.page, { fontFamily: settings.fontName }]}>
        <View style={styles.header}>
          ...
          <View style={{ alignItems: "flex-end" }}>
            <Text style={[styles.invoiceTitle, { color: primaryColor }]}>{data.invoiceTitle || "DOCUMENT"}</Text>
        ...
        <View style={{ marginBottom: 20 }}>
          <Text style={styles.sectionTitle}>{data.customerLabel || "Party"}</Text>
