    ...
    <Document>
      <Page size="A4" style={[styles.page, { fontFamily: settings.fontName }]}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.boxedDetails}>
            ...
            <View style={{ flexDirection: "row", justifyContent: "space-between", marginBottom: 4 }}>
              <Text style={{ fontSize: 9, fontWeight: "heavy" }}>Invoice No:</Text>
              <Text style={{ fontSize: 9 }}>{data.invoiceNumber}</Text>
            </View>
            <View style={{ flexDirection: "row", justifyContent: "space-between", marginBottom: 4 }}>
              <Text style={{ fontSize: 9, fontWeight: "heavy" }}>Date:</Text>
              <Text style={{ fontSize: 9 }}>{data.invoiceDate.replace("Invoice date: ", "")}</Text>
            </View>
            {data.dueDate && (
        ...
        <View style={{ marginBottom: 20 }}>
          <Text style={styles.sectionTitle}>{data.customerLabel || "Bill To"}</Text>
