...
export function PurchaseOrderDocument({ data, settings }: { data: InvoiceTemplateData; settings: TemplateSettings }) {
      ...
      <Page size="A4" style={[styles.page, { fontFamily: settings.fontName }]}>
        <View style={styles.header}>
          ...
          <View style={{ alignItems: "flex-end" }}>
            <Text style={[styles.invoiceTitle, { color: primaryColor }]}>PURCHASE ORDER</Text>
