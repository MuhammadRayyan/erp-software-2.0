...
file_path = "src/modules/sales-credit-notes/credit-note-service.ts"
...
content = re.sub(
    ...
    'const lines = calculateLines(sqlite, data.lines, minorUnit, { accountTypeFilter: "income", taxDirection: "sales", supportItems: false, accountFieldOnLine: "salesAccountId" });',
    content
)
